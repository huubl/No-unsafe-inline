...
class No_Unsafe_Inline_Admin {
	...
	public function print_fix_setattribute_style(): void {
		...
		printf(
			...
			esc_html( $enabled ),
			esc_html__( 'Global replace Element.setAttribute() with Element.style.property = val, Element.insertAdjacentHTML(), Element.innerHTML setter, Node.appendChild(), Node.insertBefore() and override jQuery htmlPrefilter() for CSP-safe applying of inline styles.', 'no-unsafe-inline' ),
